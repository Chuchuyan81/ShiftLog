    ...
    switch (sortValue) {
        ...
        case 'venue':
            sortedShifts.sort((a, b) => {
                ...
                const venueA = (venueARecord && venueARecord.name) ? venueARecord.name : (a.is_workday ? 'Не указано' : 'Выходной');
                const venueB = (venueBRecord && venueBRecord.name) ? venueBRecord.name : (b.is_workday ? 'Не указано' : 'Выходной');
...
function exportData() {
    ...
    reportsShifts.forEach(shift => {
        const venueRecord = venues.find(v => v.id === shift.venue_id);
        const venueName = (shift.venues && shift.venues.name) || (venueRecord && venueRecord.name) || (shift.is_workday ? 'Не указано' : 'Выходной');
